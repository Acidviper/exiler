...
HALV_paintshop_selected = {
	...
	switch(true)do{
		...
		case (HALV_paintshop_vehicletopaint isKindOf "Exile_Construction_Abstract_Static"):{
			...
			["saveBasePartPaintRequest",[ExileClientSessionId,HALV_paintshop_vehicletopaint]] call ExileClient_system_network_send;
		};
		default{
...
while{alive player}do{
	_nearpaintshops = (nearestObjects [player,_paintshopbuildings,35])-[player];
