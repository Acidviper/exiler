...
_message = _message + modCheckCUPWeapons;
_message = _message + modCheckCUPUnits;
_message = _message + modCheckCUPTerrainCore;
_message = _message + modCheckCUPTerrainMaps;
_message = _message + modCheckCUPVehicles;
_message = _message + modCheckCBA;
_message = _message + modCheckTRYKUniforms;
_message = _message + modCheckDShouses;
//_message = _message + modCheckEnhancedMovement;
_message = _message + modCheckSADMinigunFix;
