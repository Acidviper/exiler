...
{
	["ErrorTitleAndText", ["Failed to change PIN!", "Either not enough money or trying to change pin on vehicle without pin!"]] call ExileClient_gui_toaster_addTemplateToast;
};
true